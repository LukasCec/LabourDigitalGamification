...
export default function Win({ score, distance, benefitsCollected, collectedBenefits, onRestart, onMainMenu }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: 'absolute',
        inset: 0,
        background: 'radial-gradient(circle at 30% 20%, rgba(34,197,94,0.13) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(250,204,21,0.13) 0%, transparent 50%)',
        pointerEvents: 'none'
      }} />
      <motion.div
      ...
      >
        ...
        >
          <h1 style={{
            ...
            fontWeight: 900,
            margin: 0,
            background: 'linear-gradient(135deg, #22c55e, #fde047, #facc15)',
        ...
        >
          ...
          <div style={{
            ...
            {BENEFITS.map((benefit, index) => {
              const collected = collectedBenefits.includes(benefit.id)
              return (
                <motion.div
                  key={benefit.id}
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: collected ? 1 : 0.4, x: 0 }}
